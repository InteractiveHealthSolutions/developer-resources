...
public final class MDHashUtil {
     ...
     *
     * @param string to get the hash code of
     * @return byte[] hash code of input string
     */
    private static byte[] getHashCode(String string) {
        try {
            // For now, we will be using SHA; alternatives are SHA2, SHA256,
            // etc.
     ...
     *
     * @param string     : string to match with the hash code
     * @param hashString : hash code to match with the string
     ...
     *
     * @param string : hash code to convert into string
